...
// indexing ops...
  ...
  T  operator()(int row, int col) const;   // double x = mat(2, 3);
...
template <typename T> T& matrix3d<T>::operator()(int row, int col) { return cols_[col][row]; }  // FIXED
// template <typename T> T* matrix3d<T>::opengl_memory(int row, int col) { /* TODO */ return cols_[0][0]; }  // and this
// implement code here
//=================================================================================================
